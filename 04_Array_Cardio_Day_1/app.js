...
const fifteenBorn = inventors.filter(inventor => inventor.year < 1600 && inventor.year >= 1500);
console.table(fifteenBorn);

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
fifteenBorn.map(inventor => console.log(inventor.first + " " + inventor.last));
...
const data = ['bus', 'bus', 'car', 'car', 'truck', 'truck', 'bus', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck' ];
